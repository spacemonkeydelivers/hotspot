...
#ifndef CPU_RISCV_VM_CPPINTERPRETERGENERATOR_RISCV_HPP
#define CPU_RISCV_VM_CPPINTERPRETERGENERATOR_RISCV_HPP
...
#endif // CPU_RISCV_VM_CPPINTERPRETERGENERATOR_RISCV_HPP
