...
#ifndef CPU_RISCV_VM_BYTECODEINTERPRETER_RISCV_INLINE_HPP
#define CPU_RISCV_VM_BYTECODEINTERPRETER_RISCV_INLINE_HPP

#ifdef CC_INTERP

// Inline interpreter functions for riscv.
...
#endif // CPU_RISCV_VM_BYTECODEINTERPRETER_RISCV_INLINE_HPP
