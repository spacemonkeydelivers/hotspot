...
void CppInterpreterGenerator::generate_compute_interpreter_state(Label& stack_overflow_return) {
  ...
  // TODO: RISCV port: assert(4 == sizeof(AccessFlags), "unexpected field size");
  __ lwa(access_flags, method_(access_flags));

  // parameter_count = method->constMethod->size_of_parameters();
  // TODO: RISCV port: assert(2 == ConstMethod::sz_size_of_parameters(), "unexpected field size");
  ...
  // TODO: RISCV port: assert(2 == ConstMethod::sz_max_locals(), "unexpected field size");
  __ lhz(local_count, in_bytes(ConstMethod::size_of_locals_offset()), max_stack);

  // max_stack = method->constMethod()->max_stack();
  // TODO: RISCV port: assert(2 == ConstMethod::sz_max_stack(), "unexpected field size");
  ...
  // BANG THE STACK
  //
  // Nothing to do for RISCV, because updating the SP will automatically
  // bang the page.
...
address CppInterpreterGenerator::generate_normal_entry(void) {
  ...
  if (Arguments::has_profile()) {
    // On RISCV64 we store the pointer to the current BytecodeInterpreter,
  ...
  // TODO: RISCV port: guarantee(4 == BytecodeInterpreter::sz_msg(), "unexpected field size");
  ...
  // `callee'.
  //
  // This is our current idea on how OSR should look like on RISCV64:
  //
...

  {
    ...
    // TODO: RISCV port: assert(4 == BytecodeInterpreter::sz_msg(), "unexpected field size");
...
void AbstractInterpreter::layout_activation(Method* method,
  ...
  // Provide pop_frame capability on RISCV64, add popframe_args.
