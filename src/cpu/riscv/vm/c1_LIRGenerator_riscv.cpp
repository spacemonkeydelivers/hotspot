...
#endif
LIR_Opr LIRGenerator::exceptionOopOpr()              { return 0;     }
LIR_Opr LIRGenerator::exceptionPcOpr()               { return 0;     }
LIR_Opr LIRGenerator::divInOpr()                     { return 0; }//FIXME
LIR_Opr LIRGenerator::divOutOpr()                    { return 0; } //FIXME
LIR_Opr LIRGenerator::remOutOpr()                    { return 0; } //FIXME
LIR_Opr LIRGenerator::shiftCountOpr()                { return 0; } //
LIR_Opr LIRGenerator::syncTempOpr()                  { return 0;     }
LIR_Opr LIRGenerator::getThreadTemp()                { return  LIR_OprFact::illegalOpr;  } //
...
void LIRGenerator::cmp_mem_int(LIR_Condition, LIR_OprDesc*, int, int, CodeEmitInfo*)
{
    Unimplemented();
}    

void LIRGenerator::cmp_reg_mem(LIR_Condition, LIR_OprDesc*, LIR_OprDesc*, int, BasicType, CodeEmitInfo*)
{
    Unimplemented();
}
